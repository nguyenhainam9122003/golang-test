...
// Conversion functions (same as in server.go)
...
// Enum conversion functions (same as in server.go)
...
func convertDomainToProtoFilter(domainFilter *model.ProductFilter) grpcproduct.ProductFilter {
	protoFilter := grpcproduct.ProductFilter{}
	
	if domainFilter.ProductType != nil {
		productType := convertDomainProductType(model.ProductType(*domainFilter.ProductType))
		protoFilter.ProductType = &productType
	}
	if domainFilter.SellingStatus != nil {
		sellingStatus := convertDomainSellingStatus(model.SellingStatus(*domainFilter.SellingStatus))
		protoFilter.SellingStatus = &sellingStatus
	}
